...
// adjust servo position according to the USS read value
  ...
  if(dist_ema<dist_min) myservo.writeMicroseconds(_DUTY_MIN);
  else if(dist_ema>dist_max) myservo.writeMicroseconds(_DUTY_MAX);
  else if(dist_min<=dist_ema<=dist_max)myservo.writeMicroseconds(_DUTY_MIN + ((_DUTY_MAX - _DUTY_MIN)/(dist_max - dist_min))*(dist_ema - dist_min));
  // add your code here!

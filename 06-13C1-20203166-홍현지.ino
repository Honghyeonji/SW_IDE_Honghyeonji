...
#define _SERVO_SPEED 3 // servo speed limit (unit: degree/second) (3 or 0.3)
#define INTERVAL 33  // servo update interval ( IF _SERVO_SPEED == 3: 33, IF _SERVO_SPEED == 0.3: 326 )
